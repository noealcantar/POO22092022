 ...
 * @author Noé
 */
public class Cifrar extends JPanel {
    ...
    public Cifrar() {
        ...
        label1 = new JLabel("Ingresa el texto:");
        cuadro1 = new JTextArea(20,20);  
        sc = new JScrollPane(cuadro1);   
        label2 = new JLabel("Texto cifrado:");
        ...
        boton.setToolTipText("Presiona para cifrar el texto");
